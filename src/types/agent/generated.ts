...
export const AGENT_ERROR_DEFINITIONS = [
  ...
  {
    code: 6052,
    key: 'AI_EVIDENCE_PROJECTION_FAILED',
    httpStatus: 500,
    retryable: false,
    message: '研究证据投影失败，结果未发布',
  },
  {
    code: 6053,
    key: 'AI_TASK_FULFILLMENT_FAILED',
    httpStatus: 422,
    retryable: false,
    message: '研究结果未满足任务合同',
  },
  {
    code: 6054,
    key: 'AI_RUN_OUTPUT_TOKEN_GUARDRAIL_EXCEEDED',
    httpStatus: 422,
    retryable: false,
    message: '模型配置的最大输出超过 Run 剩余输出 Token 护栏',
  },
  {
    code: 6055,
    key: 'AI_TASK_CONTRACT_INVALID',
    httpStatus: 422,
    retryable: false,
    message: '任务合同无效，无法继续执行',
  },
  {
    code: 6056,
    key: 'AI_REQUIRED_EVIDENCE_MISSING',
    httpStatus: 422,
    retryable: false,
    message: '任务所需证据缺失',
  },
  {
    code: 6057,
    key: 'AI_MODEL_AUTH_FAILED',
    httpStatus: 502,
    retryable: false,
    message: '模型供应商鉴权失败，请检查部署凭据和模型权限',
  },
  {
    code: 6058,
    key: 'AI_MODEL_REQUEST_REJECTED',
    httpStatus: 422,
    retryable: false,
    message: '模型供应商拒绝了当前请求',
  },
  {
    code: 6059,
    key: 'AI_MODEL_OUTPUT_INVALID',
    httpStatus: 502,
    retryable: true,
    message: '模型输出协议无效，自动修复与备用路由均未成功',
  },
  {
    code: 6099,
