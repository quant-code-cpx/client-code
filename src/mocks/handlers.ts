...
const operationsOverviewMock = {
  ...
  freshness: [
    ['STOCK_DAILY', 'Daily', 'DAILY', 'CORE', '20260808', 0, 'READY'],
    ['STOCK_DAILY_BASIC', 'DailyBasic', 'DAILY_BASIC', 'CORE', '20260808', 0, 'READY'],
    ['STOCK_ADJ_FACTOR', 'AdjFactor', 'ADJ_FACTOR', 'CORE', '20260808', 0, 'READY'],
    ['STOCK_TECHNICAL_FACTOR', 'StkFactor', 'STK_FACTOR', 'CORE', '20260807', 1, 'LATE'],
    ['INDEX_DAILY', 'IndexDaily', 'INDEX_DAILY', 'CORE', '20260808', 0, 'READY'],
    ['STOCK_MONEYFLOW', 'Moneyflow', 'MONEYFLOW', 'IMPORTANT', '20260807', 1, 'SYNCING'],
    ['SECTOR_DAILY', 'ThsDaily', 'THS_DAILY', 'IMPORTANT', '20260808', 0, 'READY'],
